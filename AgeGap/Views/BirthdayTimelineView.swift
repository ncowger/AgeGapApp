                ...
                if filteredPeople.isEmpty {
                    ...
                    ZStack(alignment: .bottom) {
                        ScrollView {
                            ...
                            .padding()
                            // Extra bottom padding so the card doesn't cover last row
                            .padding(.bottom, selectedPeople.count == 2 ? 130 : 0)
                        }

                        // Gap comparison card — slides up when 2 are selected
                ...
                HStack(alignment: .center, spacing: 16) {
                    ...
                    VStack(spacing: 0) {
                        ...
                        ZStack {
                            ...
                            // Show 1 or 2 badge for selection order
...
struct GapComparisonCard: View {
    ...
    private func personChip(_ person: Person, label: String) -> some View {
        ...
        .padding(.vertical, 8)
        .background(tags.color(for: person.relationshipTag).opacity(0.12))
